# Terms of Service for Fishing Lure Analyzer
...
Welcome to Fishing Lure Analyzer ("we," "our," or "us"). These Terms of Service ("Terms") constitute a legally binding agreement between you and us regarding your use of our mobile application ("App") and related services.

By downloading, installing, accessing, or using our App, you agree to be bound by these Terms. If you do not agree to these Terms, you may not use our App.

## Age Requirements

You must be at least 13 years of age to use this App. If you are between 13 and 18 (or the age of majority in your jurisdiction), you represent that you have your parent's or guardian's permission to use the App and that they have agreed to these Terms on your behalf.
...
### Permitted Use
You may use the App for lawful purposes only, including:
- Identifying fishing lures through AI analysis
...
- Upload images that contain illegal, harmful, or offensive content
...
- Share your account with others or create multiple accounts to circumvent usage limits
...
- **Features:**
  ...
  - Priority support
- **Billing:** Charged monthly on your subscription anniversary date
...
- Renewal charges occur automatically unless you cancel before the renewal date
...
- Each store has its own refund policies and procedures
- Generally, refunds may be available within a certain time period after purchase
...
- We reserve the right to terminate subscriptions for violations of these Terms
- No refunds will be provided for terminated subscriptions
- Upon termination, premium features will be immediately disabled

## AI Analysis Service

### Service Description
- Our App uses AI technology (OpenAI GPT-4 Vision API) to analyze fishing lure images
- AI analysis is provided "as-is" and may not always be 100% accurate
- Analysis results are for informational purposes only

### Accuracy Disclaimer
- AI analysis is based on image recognition and may produce incorrect identifications
- We do not guarantee the accuracy, completeness, or reliability of AI analysis results
- Always verify information independently, especially for safety-critical decisions

### Image Content
- You are responsible for the images you upload
- Images must be of fishing lures only
- We reserve the right to reject or delete inappropriate images

## Intellectual Property

### Our Rights
- The App, including its design, code, content, and features, is owned by us
...
- By uploading content, you grant us a license to use, store, and process your content to provide the App's services
- You represent that you have the right to upload any content you provide

## Privacy

Your use of the App is also governed by our Privacy Policy, which can be found at [PRIVACY_POLICY_URL]. By using the App, you consent to the collection and use of information as described in our Privacy Policy.
...
- The App may experience downtime for maintenance or technical issues
- We are not liable for any loss resulting from App unavailability
...
- We are not responsible for fishing-related accidents, injuries, or property damage
- Always follow local fishing regulations and safety guidelines
- Use your own judgment when making fishing decisions
...
- Cancellation of subscriptions is subject to the cancellation policy above
...
Your continued use of the App after changes become effective constitutes acceptance of the updated Terms. If you do not agree to the changes, you must stop using the App.
...
- Google's Terms of Service also apply to your use of the App
...
*These Terms of Service are effective as of December 20, 2024 and apply to all users of Fishing Lure Analyzer.*
